...
namespace Dive
{
	...
	{
	public:
		DvApplication(const std::wstring title = L"DIVE", uint32_t windowWidth = 800, uint32_t windowHeight = 600, bool fullscreen = false);
		virtual ~DvApplication();
		...
		void SetTitle(const std::wstring& title);
		 ...
		 static DvApplication& GetApplication() { return *s_pInstance; }
	...
	private:
		...
		static DvApplication* s_pInstance;
	};
}

...
namespace Dive
{
	...
	class DvCamera : public DvComponent
	{
	public:
	...
	public:
		DvCamera(DvGameObject* pGameObject);
		~DvCamera() override;
		...
		DvRenderTexture* GetRenderTarget() const { return m_pRenderTarget; }
		void SetRenderTarget(DvRenderTexture* pRenderTarget) { m_pRenderTarget = pRenderTarget; }
	...
	protected:
		...
		DvRenderTexture* m_pRenderTarget;
	};
}
...
namespace Dive
{
	...
	public:
		...
		static void SetTexture(eTextureUnit index, DvTexture* pTexture);
		static void SetShader(DvShader* pShader);
		static void SetVertexBuffer(DvVertexBuffer* pBuffer);
		static void SetIndexBuffer(DvIndexBuffer* pBuffer);
	...
	private:
		...
		static DvVertexBuffer* s_pVertexBuffer;
		static DvIndexBuffer* s_pIndexBuffer;

		static DvShader* s_pShader;

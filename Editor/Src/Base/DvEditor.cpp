...
#include "Panels/DvMenuBarPanel.h"
#include "Panels/DvScenePanel.h"
#include "Panels/DvHierarchyPanel.h"
...
namespace Editor
{
	...
	void DvEditor::Start()
	{
		...
		// Create Panels
		m_pMenuBar = new DvMenuBarPanel(this);
		m_pScene = new DvScenePanel(this);
		m_pHierarchy = new DvHierarchyPanel(this);
		m_pInspector = new DvInspectorPanel(this);
		m_pAsset = new DvAssetPanel(this);
	}
